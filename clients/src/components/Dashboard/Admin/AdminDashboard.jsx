                    ...
                    <div style={{ overflowX: 'auto', whiteSpace: 'nowrap', maxWidth: '100%' }}>
                        {lowStockProducts.length > 0 ? lowStockProducts.map((prod, idx) => (
                            <span key={prod._id || idx} style={{ display: 'inline-block', marginRight: 24 }}>
                                ...
                                <a href="" className="link-orange text-decoration-underline fw-semibold" data-bs-toggle="modal" data-bs-target="#add-stock">Add Stock</a>
                            </span>
                        )) : (
                        ...
                        <div className="card bg-secondary sale-widget flex-fill">
                            <div className="card-body d-flex align-items-center">
                                ...
                                <div className="ms-2">
                                    ...
                                    <div className="d-inline-flex align-items-center flex-wrap gap-2">
                                        <h4 className="text-white">₹ {totalCreditNoteAmount.toLocaleString()}</h4>
                        ...
                        <div className="card bg-teal sale-widget flex-fill">
                            <div className="card-body d-flex align-items-center">
                                ...
                                <div className="ms-2">
                                    ...
                                    <div className="d-inline-flex align-items-center flex-wrap gap-2">
                                        <h4 className="text-white">₹ {totalPurchaseAmount.toLocaleString()}</h4>
                        ...
                        <div className="card bg-info sale-widget flex-fill">
                            <div className="card-body d-flex align-items-center">
                                ...
                                <div className="ms-2">
                                    ...
                                    <div className="d-inline-flex align-items-center flex-wrap gap-2">
                                        <h4 className="text-white">₹ {totalDebitNoteAmount.toLocaleString()}</h4>
                                        {/* <span className="badge badge-soft-success"><i
                                            className="ti ti-arrow-up me-1" />+22%</span> */}
                                    </div>
                                </div>
                        ...
                        <div className="card revenue-widget flex-fill">
                            <div className="card-body">
                                ...
                                <div className="d-flex align-items-center justify-content-between">
                                    ...
                                    <a href="/online-orders" className="text-decoration-underline fs-13 fw-medium">View
                                        All</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col-xl-3 col-sm-6 col-12 d-flex">
                        <div className="card revenue-widget flex-fill">
                            <div className="card-body">
                                <div className="d-flex align-items-center justify-content-between mb-3 pb-3 border-bottom">
                                    <div>
                                        <h4 className="mb-1">₹ {totalExpensesAmount.toLocaleString()}</h4>
                    ...
                    <div className="col-xl-3 col-sm-6 col-12 d-flex">
                        <div className="card revenue-widget flex-fill">
                            <div className="card-body">
                                <div className="d-flex align-items-center justify-content-between mb-3 pb-3 border-bottom">
                                    <div>
                                        <h4 className="mb-1">₹ {totalStockValue.toLocaleString()}</h4>
                    ...
                    <div className="col-xxl-8 col-xl-7 col-sm-12 col-12 d-flex">
                        <div className="card flex-fill">
                            <div className="card-header d-flex justify-content-between align-items-center flex-wrap gap-3">
                                <div className="d-inline-flex align-items-center">
                                    <span className="title-icon bg-soft-pink fs-16 me-2"><TbBox className="ti ti-box" /></span>
                    ...
                    <div className="col-xxl-4 col-xl-5 d-flex">
                        <div className="card flex-fill">
                            <div className="card-header">
                                <div className="d-inline-flex align-items-center">
                                    <span className="title-icon bg-soft-info fs-16 me-2"><TbInfoCircle
                ...
                <div className="row">
                    <div className="col-xxl-12 col-xl-7 col-sm-12 col-12 d-flex">
                        <div className="card flex-fill">
                            <div className="card-header d-flex justify-content-between align-items-center flex-wrap gap-3">
                                <div className="d-inline-flex align-items-center">
                                    <span className="title-icon bg-soft-pink fs-16 me-2"><FcExpired className="ti ti-box" /></span>
                                    <h5 className="card-title mb-0">Upcomming Expired Products</h5>
                                </div>
                                <div className="dropdown">
                                    <a href="" className="dropdown-toggle btn btn-sm btn-white"
                                        data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <div className="card-body">
                                <div className="table-responsive">
                                    <table className="table table-borderless custom-table">
                                        ...
                                        <tbody>
                                            {expiredLoading ? (
                                                <div className="text-muted">Loading expired products...</div>
                                            ) : expiredProducts.length === 0 ? (
                                                <div className="text-muted">No expired products found.</div>
                                            ) : (
              ...
              <td>{p.availableQuantity}</td>
                    ...
                    <div className="col-xxl-4 col-md-6 d-flex">
                        <div className="card flex-fill">
                            <div className="card-header d-flex justify-content-between align-items-center flex-wrap gap-3">
                                <div className="d-inline-flex align-items-center">
                                    <span className="title-icon bg-soft-danger fs-16 me-2"><TbAlertTriangle
                                ...
                                {lowStockProducts.length > 0 ? lowStockProducts.map(product => (
                                    <div className="d-flex align-items-center justify-content-between mb-4" key={product._id}>
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div className="ms-2">
                                                <h6 className="fw-bold mb-1"><a href="">{product.productName || product.name || 'N/A'}</a></h6>
