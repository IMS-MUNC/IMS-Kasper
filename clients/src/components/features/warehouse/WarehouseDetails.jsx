...
//           warehousesDetails.blocks.slice(0,2).map((block, idx) => (
//             <>
//               <div
//                 key={idx}
//                 style={{
              ...
              <>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <PiWarehouseBold
                        style={{ color: "#1368EC", fontSize: "25px" }}
                      />{" "}
                      {block.zone}
                    </span>
                    <span>
                  ...
                  >
                    {block.cells?.length > 0
                      ? (
                          `${
                            block.cells.filter((cell) => cell.items?.length > 0)
                              .length
                          }` *
                          (100 / `${block.cells.length}`)
                        ).toFixed(2) + " %"
                      : ""}
                  </span>
                ...
                {filteredPurchases &&
                  filteredPurchases.slice(0, 5).map((purchase) => (
                    <tr key={purchase._id} style={{ cursor: "pointer" }}>
                      ...
                      >
                        {
                          purchase.products[0]?.product?.warehouse
                            ?.warehouseName
                        }
                      </td>
                      <td
