          ...
          <div className="content-wrap">
            ...
            onChange={(e) => handleProductSearch(e.target.value)}/>
              ...
              products.map((product) => {
                ...
                return (
                  // <div  key={product._id} className="col-sm-6 col-md-6 col-lg-6 col-xl-4 col-xxl-3" onClick={() => product.quantity > 0 && handleProductClick(product)}>
                  ...
                  //           <span><TbCircleCheckFilled className="ti ti-circle-check-filled" /></span>
                  //           {/* <span><TbCircleCheckFilled className="ti ti-circle-check-filled" /></span> */}
                  //         </a>
                  //         <h6 className="cat-name"><a href="" >{product.category?.categoryName}</a></h6>
                  //         <h6 className="product-name text-capitalize"><a href="" >{product.productName}</a></h6>
                  ...
                  //           </div>
                  //           <p className="text-gray-9 mb-0">{product.quantity}{product.unit}</p>
                  //         </div>
                  //       </div>
                  //     </div>
                  <div
                  ...
                  >
                    <div className="product-info card mb-0" style={{ height: "220px" }}>
                      ...
                      {/* Image Container */}
                      <div
                        className="pro-img d-flex align-items-center justify-content-center"
                        style={{
                          height: "120px", // ✅ all images same height box
                          width: "100%",
                          overflow: "hidden",
                        }}
                      >
                        {product.images && product.images.length > 0 && product.images[0] ? (
                          <img
                            ...
                            style={{
                              ...
                              width: "100%",    // ✅ fit width
                              objectFit: "contain", // ✅ maintain ratio, no crop
                            }}
                            onError={(e) => {
                    ...
                    <div className="row g-3">
                      <div className="col-sm-6 col-md-6 col-lg-6 col-xl-4 col-xxl-3">
                        <div className="product-info card mb-0">
                          ...
                          <h6 className="cat-name"><a href="">Headphones</a></h6>
                          <h6 className="product-name"><a href="">Airpod 2</a></h6>
                          <div className="d-flex align-items-center justify-content-between price">
                            <p className="text-gray-9 mb-0">$5478</p>
                            <div className="qty-item m-0">
                              <a href="" className="dec d-flex justify-content-center align-items-center" data-bs-toggle="tooltip" data-bs-placement="top" title="minus"><i className="ti ti-minus" /></a>
                              <input type="text" className="form-control text-center" name="qty" defaultValue={4} />
                              <a href="" className="inc d-flex justify-content-center align-items-center" data-bs-toggle="tooltip" data-bs-placement="top" title="plus"><i className="ti ti-plus" /></a>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div className="col-sm-6 col-md-6 col-lg-6 col-xl-4 col-xxl-3">
                        <div className="product-info card mb-0">
                          <a href="" className="pro-img">
                            ...
                            <span><i data-feather="check" className="feather-16" /></span>
                          </a>
                          <h6 className="cat-name"><a href="">Headphones</a></h6>
                          <h6 className="product-name"><a href="">SWAGME</a></h6>
                          <div className="d-flex align-items-center justify-content-between price">
